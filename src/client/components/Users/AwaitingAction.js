...
const AwaitingAction = (props) => {
  ...
  const filteredAwaitedRecords = props.userRemRecords.filter(
    (id) => props.userData[id].IsApproved === ""
  );

  const sortedFilteredAwaitedRecords = filteredAwaitedRecords.sort();

  const currentUserAwaitedRecords = sortedFilteredAwaitedRecords.slice(
    indexOfFirstPost,
    indexOfLastPost
  );
  ...
  return (
    <Fragment>
      {" "}
      {currentUserAwaitedRecords.length !== 0 ? (
        <div className="detailsMaindiv">
          <div className="flexdetails">
            <div className="flex-individual">
              {currentUserAwaitedRecords.map((id) => (
                  ...
                  <div>
                    ...
                    {/* <div className="remList-single">
                      <h3 className="h3Field-class">
                        Employee Account:{" "}
                        <span className="spanDta-field">
                          {props.userData[id].EmployeeAccount}
                        </span>
                      </h3>
                    </div> */}
                    <div className="remList-single">
