...
const DeclinedForFundsAdmin = (props) => {
  return (
    <Fragment>
      {props.filterDeclinedAdminDataUsingId.length !== 0 ? (
        <Card>
          <div className="remList-single" style={{ marginBottom: "10px" }}>
            <h3 className="h3Field-class">
              Total Records:{" "}
              <span className="spanDta-field">
                {props.filterDeclinedAdminDataUsingId.length}
              </span>
            </h3>
          </div>
          {props.filterDeclinedAdminDataUsingId.length !== 0 && (
          ...
          <div className="div-horizontal">
            ...
            >
              ...
              <tbody>
                {props.filterDeclinedAdminDataUsingId.map((id) => (
                  <tr key={id}>
                    <td>{id}</td>
...
export default DeclinedForFundsAdmin;
